...
const metrics: Array<{ label: string; value: LeaderboardMetric }> = [
  ...
  { label: 'Партии', value: 'games' },
  { label: 'Короны', value: 'crowns' },
  { label: 'Говна', value: 'shits' },
  { label: 'Среднее место', value: 'avg_place' },
]
...
export function LeaderboardPage() {
  ...
  if (leaderboardQuery.isLoading) {
    return <PageStatus title="Загружаем таблицу..." />
  }
  ...
  if (leaderboardQuery.isError || !leaderboardQuery.data) {
    return (
      <EmptyState
        ...
        description="Stats API не вернул payload для таблицы."
      />
    )
  }
